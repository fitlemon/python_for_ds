...
# Конспект по Модулю #7 **Визуализация данных**  :blue_book:
...
8. [ДПО. Продвинутые методы МО. Визуализация данных. Семинар №1 ](8_data_visual_mipt.ipynb)
9. [ДПО. Продвинутые методы МО. Визуализация данных. Домашнее задание №1 ](9_data_visual_mipt_hw1.ipynb)
10. [ДПО. Продвинутые методы МО. Визуализация данных. Домашнее задание №2 ](10_data_visual_mipt_hw2.ipynb)
11. [ДПО. Продвинутые методы МО. Визуализация данных. Домашнее задание №3 ](11_data_visual_mipt_hw3.ipynb)
12. [ДПО. Продвинутые методы МО. Визуализация данных. Семинар №2 ](12_data_visual_mipt_practice.ipynb)
13. [ДПО. Продвинутые методы МО. Визуализация данных. Домашнее задание №4 ](13_adv_ml_module_2_hw4.ipynb)
